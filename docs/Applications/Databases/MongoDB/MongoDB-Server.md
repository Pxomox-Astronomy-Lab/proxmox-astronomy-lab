...
description: "Documentation for MongoDB Server in the Proxmox Astronomy Lab"
author: "VintageDon"
tags: ["documentation", "applications", "", "mongodb server"]
...
MongoDB Server is a [brief description of the service, its purpose, and the business value it provides].
