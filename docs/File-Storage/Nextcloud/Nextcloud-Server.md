...
description: "Documentation for Nextcloud Server in the Proxmox Astronomy Lab"
author: "VintageDon"
tags: ["documentation", "applications", "", "nextcloud server"]
...
Nextcloud Server is a [brief description of the service, its purpose, and the business value it provides].
