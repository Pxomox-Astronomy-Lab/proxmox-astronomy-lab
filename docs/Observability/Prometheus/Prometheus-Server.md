...
description: "Documentation for Prometheus Server in the Proxmox Astronomy Lab"
author: "VintageDon"
tags: ["documentation", "applications", "", "prometheus server"]
...
Prometheus Server is a [brief description of the service, its purpose, and the business value it provides].
