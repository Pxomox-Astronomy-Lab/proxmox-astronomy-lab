...
description: "Documentation for Grafana Server in the Proxmox Astronomy Lab"
author: "VintageDon"
tags: ["documentation", "applications", "", "grafana server"]
...
Grafana Server is a [brief description of the service, its purpose, and the business value it provides].
