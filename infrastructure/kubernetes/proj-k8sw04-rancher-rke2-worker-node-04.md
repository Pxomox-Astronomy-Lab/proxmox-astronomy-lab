---
title: "Proj-K8SW04 Service Documentation"
description: "Comprehensive ITIL-aligned documentation of Proj-K8SW04, including infrastructure, security policies, and service management details."
author: "VintageDon"
...
Proj-K8SW04 is a **Kubernetes worker node** in the Proxmox Astronomy Lab, running **RKE2 on Ubuntu 24.04**. It provides **compute resources, workload scheduling, and container execution** for **scientific computing, machine learning, and data processing pipelines**.

This node ensures **high-performance computing, workload distribution, and resilient AI/ML task execution**, supporting **real-time data processing and automation frameworks**.
...
Proj-K8SW04 runs **RKE2 on Ubuntu 24.04**, providing **compute resources for containerized workloads, AI model training, and real-time analytics**.

### **3.2 Infrastructure Components**  

| **Component** | **Description** |
|--------------|----------------|
| **Hostname** | proj-k8sw04.beardinthe.cloud |
| **OS** | Ubuntu 24.04 |
| **CPU** | 8 vCPUs |
| **RAM** | 32GB |
...
|------------|---------|-------------|
| 1.0 | 2025-03-07 | Initial version, defines Proj-K8SW04 as a Kubernetes worker node |
