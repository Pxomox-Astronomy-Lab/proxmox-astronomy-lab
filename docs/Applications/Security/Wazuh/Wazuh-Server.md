...
description: "Documentation for Wazuh SIEM Server in the Proxmox Astronomy Lab"
author: "VintageDon"
tags: ["documentation", "applications", "", "wazuh server"]
...
# **Wazuh SIEM Server Service**

## **1. Service Overview**

### **1.1 Service Description**

Wazuh SIEM Server is a [brief description of the service, its purpose, and the business value it provides].
