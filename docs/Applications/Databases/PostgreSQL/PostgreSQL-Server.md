...
description: "Documentation for PostgreSQL Server in the Proxmox Astronomy Lab"
author: "VintageDon"
tags: ["documentation", "applications", "", "postgresql server"]
...
PostgreSQL Server is a [brief description of the service, its purpose, and the business value it provides].
