...
Proj-K8SW05 is a **Kubernetes worker node** in the Proxmox Astronomy Lab, running **RKE2 on Ubuntu 24.04**. It provides **compute resources, workload scheduling, and container execution** for **scientific computing, AI/ML processing, and distributed applications**.

This node ensures **high-performance computing, balanced workload distribution, and efficient research task execution**, supporting **real-time analytics, data enrichment, and automation frameworks**.
...
Proj-K8SW05 runs **RKE2 on Ubuntu 24.04**, providing **compute resources for containerized workloads, AI/ML model training, and scientific research applications**.

### **3.2 Infrastructure Components**  

| **Component** | **Description** |
|--------------|----------------|
| **Hostname** | proj-k8sw05.beardinthe.cloud |
| **OS** | Ubuntu 24.04 |
| **CPU** | 8 vCPUs |
| **RAM** | 32GB |
